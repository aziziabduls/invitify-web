...
//                             <h3 className="font-bold text-gray-900 dark:text-zinc-100 text-lg mb-2">{event.tagline}</h3>
...
//                     <div className="relative aspect-video w-full md:w-full md:ml-[0%] overflow-hidden rounded-2xl shadow-2xl">
//                         <Image
//                             src={event.image}
//                             alt={event.name}
//                             fill
...
//                                 <span className="text-6xl md:text-8xl font-black text-black dark:text-white tracking-tighter transition-colors">{day}</span>
//                                 <span className="bg-[#3b82f6] text-white text-4xl md:text-6xl font-black px-4 py-1 rounded-lg transform -rotate-2 mt-[-10px] z-10">
//                                     {month}
//                                 </span>
//                                 <span className="text-6xl md:text-8xl font-black text-black dark:text-white tracking-tighter -mt-4 transition-colors">{year}</span>
//                             </div>
//                             <div className="mt-4 text-gray-900 dark:text-zinc-200 font-bold max-w-[200px] text-right transition-colors">
//                                 {event.location}
//                                 <br />
//                                 <span className="text-sm font-normal opacity-80">{event.locationDetail}</span>
//                             </div>
//                         </div>
//                     </div>
